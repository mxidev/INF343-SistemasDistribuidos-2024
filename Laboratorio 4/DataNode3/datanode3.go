...
type DN3Server struct {
	pb.UnimplementedMessageServiceServer
}

func (s *DN3Server) RequestInformation(ctx context.Context, message *pb.Message) (*pb.Message, error) {
...
func main() {
	...
	serv := grpc.NewServer()
	for {
		pb.RegisterMessageServiceServer(serv, &DN3Server{})
